<?php
/**
 * Title: My Projects, 2 columns
 * Slug: larris-theme/my-projects-2-columns
 * Categories: banner
 * Description: A section with 2 columns of projects.
 */
...
<p class="has-text-align-center" style="line-height:1.6">Here you will find some of the personal and clients projects that I created with each project containing its own case study</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full"><img src="http://localhost/wptest/wp-content/uploads/2025/03/hero-banner.jpg" alt="" class="wp-image-22"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph -->
<p>Larris Theme is a modern WordPress block theme perfect for building portfolios, landing pages, and blogs. It comes with predefined templates and offers extensive customization options, making it easy to create a unique and professional website with full-site editing capabilities.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>Control Cache Plugin ensures that your custom patterns are registered instantly by clearing transient data. It features an on/off slider, allowing you to enable or disable caching easily—perfect for development and live environments.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><strong>Larris Contact Form</strong> is a simple and customizable contact form for WordPress. It includes an SMTP input to ensure emails are delivered to the main inbox instead of spam, providing reliable communication for your website.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>Larris Slideshow Block is a lightweight and customizable WordPress block plugin for creating responsive slideshows. It seamlessly integrates with the block editor, offering smooth transitions and flexible settings to enhance your website’s visual appeal.</p>
<!-- /wp:paragraph -->
