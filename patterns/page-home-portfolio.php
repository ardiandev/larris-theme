 ...
 * Slug: larris-theme/page-about-portfolio
 * Categories: featured
 * Viewport width: 1400
 * Description: A portfolio page with a hero section and a grid of featured projects.
 * */
?>
<!-- wp:pattern {"slug":"larris-theme/header"} /-->
